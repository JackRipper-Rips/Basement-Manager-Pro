# 🎮 Solus Manifest App - Official Release! 🚀

**The ultimate Steam depot & manifest management tool is here!**

Download now: https://github.com/MorrenusGames/Solus-Manifest-App/releases/latest
...
• **Config VDF Extractor** - Extract depot keys from config.vdf
• **Auto Config Keys Upload** - Hourly uploads to database
• **Protocol Handler** - Quick downloads via `solus://` URLs

**📚 Library Management**
• Manage games, Lua scripts & GreenLuma apps
• Real-time search & filtering
• Steam integration - auto-detect games
• GreenLuma 2024 support (Normal, Stealth modes)
• Batch operations & context menus
